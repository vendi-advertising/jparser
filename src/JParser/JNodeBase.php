...
/* @todo Changed to abstract, is that OK? */
abstract class JNodeBase extends LRParseNode
{
    ...
    function is_transparent(/** @noinspection PhpUnusedParameterInspection */ JNodeBase $Parent)
    {
        return false;
    }
